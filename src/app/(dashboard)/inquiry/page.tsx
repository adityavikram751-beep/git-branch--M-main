...
export default function EnquiryPage() {
  ...
  return (
    <div className="min-h-screen bg-yellow-50">
      {/* ✅ MOBILE FIXED BUTTON */}
      <div className="lg:hidden fixed top-14 left-0 right-0 z-40 bg-yellow-50 pt-4 pb-3">
      ...
      {mobileSidebarOpen && (
        <>
          <div
            className="fixed inset-0 bg-black/400 z-40 lg:hidden"
      ...
      {/* MAIN CONTENT */}
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-12 py-6 sm:py-10 pt-40 lg:pt-24">
                  ...
                  {!enquiry.productId ? (
                    <div className="text-center py-6 sm:py-8">
                      ...
                      <p className="text-sm text-gray-600 mb-3 sm:mb-4 px-4">
                        This enquiry was submitted but the product details are
